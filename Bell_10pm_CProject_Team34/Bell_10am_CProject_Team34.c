 ...
 *  	- I ask the user if they would like to use one of our features
 ...
 * 		- In the second one I first ask the user if they would like me to tell them more info about our subject. I then give them options and they choose if they want to make a prosthetic or test out the prosthetic they already have.
 * 		- In the third one I quiz the user on my subject and give them a score based on how well they did.
